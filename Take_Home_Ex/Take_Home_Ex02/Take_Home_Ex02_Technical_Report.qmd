...
```{r}
pacman::p_load(jsonlite,dplyr,tidyr,skimr, knitr,kableExtra,ggplot2,stringr,tidyverse,tidygraph,ggraph,patchwork,scales,tidytext,ggalluvial,gt,visNetwork)
```
...
ggplot(df_heatmap_prep, aes(x = hour_of_day, y = factor(date_label), fill = message_count)) +
  ...
  theme(
    strip.text = element_text(face = "bold", linewidth = 11),
