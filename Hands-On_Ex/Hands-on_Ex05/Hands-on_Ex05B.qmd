...
::: callout-tip
Did you know [corrplot](https://pypi.org/project/ggcorrplot/#doc) is also available in python.
Kudos to the team for exporting this amazing package to python too
But its still lacks the flexibility that is available in R.

Incidentally found the link to [Altair](https://altair-viz.github.io/gallery/isotype_emoji.html).
I just need to find the equivalent for R for this !
:::
