...
pacman::p_load(igraph, tidygraph, ggraph, 
               ...
               concaveman, ggforce,glimpse,kable)
```

We will use 2 datasets:
1. GAStech-email_edges.csv which consists of two weeks of 9063 emails correspondances between 55 employees.
...
![](different_layout_pic.jpg)
![](different_layout_pic2.jpg)
