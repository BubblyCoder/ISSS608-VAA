...
2.  GAStech_email_nodes.csv which consist of the names, department and title of the 55 employees.
...
```{r}
knitr:::kable(head(GAStech_edges_aggregated))
```
...
Before getting started, you are advised to read these two articles: - [Introducing tidygraph](https://www.data-imaginist.com/posts/2017-07-07-introducing-tidygraph/) - [tidygraph 1.1 - A tidy hope](https://www.data-imaginist.com/posts/2018-02-12-tidygraph-1-1-a-tidy-hope/index.html)
...
![](different_layout_pic.jpg) ![](different_layout_pic2.jpg) \### Fruchterman and Reingold layout The code chunks below will be used to plot the network graph using Fruchterman and Reingold layout.
